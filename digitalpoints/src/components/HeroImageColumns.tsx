...
export default function HeroImageColumns() {
  return (
    <div
      aria-hidden="true"
      className="pointer-events-none relative mx-auto grid h-full max-w-[440px] grid-cols-2 gap-3 overflow-hidden [mask-image:linear-gradient(to_bottom,transparent,black_10%,black_90%,transparent)]"
    >
